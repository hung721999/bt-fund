...
#define DEVICE_SHORT_NAME "nhuhung72"
#define DEVICE_SHORT_NAME_LEN (sizeof(DEVICE_SHORT_NAME) - 1)
...
static const struct bt_data sd[] = {
	...
	// BT_DATA(BT_DATA_NAME_SHORTENED, DEVICE_SHORT_NAME, DEVICE_SHORT_NAME_LEN),
};
